/**
 * Stable, renderer-independent icon names.
 *
 * The catalog follows Heroicons' 24px outline vocabulary so the default web
 * renderer is lossless. Other renderers can map any supported subset.
 */
...
export interface IconSource {
    ...
    body: string;
    /** Coordinate system for the SVG source. */
    viewBox: string;
